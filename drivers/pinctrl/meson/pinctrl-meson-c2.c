...
static const struct pinctrl_pin_desc meson_c2_periphs_pins[] = {
	MESON_PIN(GPIOD_0),
	MESON_PIN(GPIOD_1),
	MESON_PIN(GPIOD_2),
	MESON_PIN(GPIOD_3),
...
static struct meson_bank meson_c2_periphs_banks[] = {
	...
	BANK_DS("D", GPIOD_0,    GPIOD_13,  0,  13,
		0x3,   0,  0x4,  0,   0x2,  0,  0x1,  0,  0x0,  0, 0x05, 0),
	BANK_DS("E", GPIOE_0,    GPIOE_2,   14, 16,
		0x13,  0,  0x14,  0,  0x12, 0,  0x11, 0,  0x10, 0, 0x15, 0),
	BANK_DS("B", GPIOB_0,    GPIOB_13,  17, 30,
		0x23,  0,  0x24,  0,  0x22, 0,  0x21, 0,  0x20, 0, 0x25, 0),
	BANK_DS("C", GPIOC_0,    GPIOC_6,   31, 37,
		0x33,  0,  0x34,  0,  0x32, 0,  0x31, 0,  0x30, 0, 0x35, 0),
	BANK_DS("X", GPIOX_0,    GPIOX_20,  38, 58,
		0x43,  0,  0x44,  0,  0x42, 0,  0x41, 0,  0x40, 0, 0x45, 0),
	BANK_DS("M", GPIOM_0,    GPIOM_13,  59, 72,
		0x53,  0,  0x54,  0,  0x52, 0,  0x51, 0,  0x50, 0, 0x55, 0),
	BANK_DS("A", GPIOA_0,    GPIOA_15,  73, 88,
		0x63,  0,  0x64,  0,  0x62, 0,  0x61, 0,  0x60, 0, 0x65, 0),
	BANK_DS("TEST_N", GPIO_TEST_N,    GPIO_TEST_N,   89, 89,
		0x73,  0,  0x74,  0,  0x72, 0,  0x71,  0, 0x70, 0, 0x75, 0),
};
...
static const struct of_device_id meson_c2_pinctrl_dt_match[] = {
	{
		.compatible = "amlogic,meson-c2-periphs-pinctrl",
		.data = &meson_c2_periphs_pinctrl_data,
	},
	{ },
};
MODULE_DEVICE_TABLE(of, meson_c2_pinctrl_dt_match);

static struct platform_driver meson_c2_pinctrl_driver = {
	.probe  = meson_pinctrl_probe,
	.driver = {
		.name	= "meson-c2-pinctrl",
		.of_match_table = meson_c2_pinctrl_dt_match,
	},
};

module_platform_driver(meson_c2_pinctrl_driver);
